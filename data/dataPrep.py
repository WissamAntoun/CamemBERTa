    ...
    if args.action == "download":
        ...
        for _dir in ["train", "test"]:
            electra_preprocessing_command = (
                "python /workspace/deberta/build_pretraining_dataset.py"
            )
            electra_preprocessing_command += (
                " --corpus-dir="
            ...
            electra_preprocessing_command += " --num-processes=" + str(
                args.num_processes
            )
            electra_preprocessing_command += (
            ...
            print("Running command: " + electra_preprocessing_command)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--num_processes",
        type=int,
        help="Specify the max number of processes to run in parralel for tfrecord creatiion",
        default=8,
    )
